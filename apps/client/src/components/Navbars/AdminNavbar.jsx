    ...
    return (
        <div className="w-4/5 flex flex-col items-center">
            ...
            >
                ...
                <Link to="/new-user" className="bg-slate-400 px-4 py-2 rounded-full text-slate-50 tracking-wider">create new contact</Link>
                <Link className="bg-slate-400 px-4 py-2 rounded-full text-slate-50 tracking-wider">create new account</Link>
