                ...
                <div className="w-1/2 text-teal-900 flex flex-col gap-2 items-end">
                    {
                       ...
                       <p className="bg-slate-50 px-1 rounded-sm text-end">{project?.startDate?.slice(0, 10)}</p> :
                       <p className="bg-slate-50 px-1 rounded-sm text-end">{project?.startDate?.slice(0, 10)} to {project?.endDate?.slice(0, 10)}</p>
                    }
