...
const ClientProjects = () => {
    ...
    return (
        <div id="client projects" className="mt-5 mb-20 w-screen flex flex-col items-center gap-10 font-serif">
            ...
            <div className="flex items-center justify-center gap-5">
                {
                    clientProjects?.map((project, index) => {
                        return (
                            <p
                                key={index}
                                className="border-double border-4 px-5 py-3 text-slate-700 tracking-wider hover:bg-orange-50 hover:cursor-pointer"
